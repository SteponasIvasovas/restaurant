...
@section('content')
<form class="col-md-8" action="{{route('dish.store')}}" method="post">
  <!-- apsauga -->
  {{ csrf_field() }}
  <div class="form-group">
    <label for="dish_title" class="control-label   col-sm-10">Title</label>
    <div class="  col-sm-10">
  ...
  <div class="form-group">
    <label for="dish_description" class="control-label   col-sm-10">Description</label>
    <div class="  col-sm-10">
      <textarea id="dish-description" class="form-control" type="text" name="description" value=""></textarea>
    </div>
  </div>
  <div class="form-group">
    <label for="dish_price" class="control-label   col-sm-10">Price</label>
    <div class="  col-sm-10">
      <input id="dish-price" class="form-control" type="text" name="price" value="">
    </div>
  </div>
  <div class="form-group">
    <label for="dish_menu_id" class="control-label   col-sm-10">Menu ID</label>
    <div class="  col-sm-10">
  ...
  <div class="form-group">
    <label for="dish_photo" class="control-label   col-sm-10">Image file</label>
    <div class="col-sm-10">
